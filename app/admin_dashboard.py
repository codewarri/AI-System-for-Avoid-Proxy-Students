...
message3 = tk.Label(window, text="AI System for Avoid Proxy Students" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="black"  ,bg="#3ece48"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
